...
class GameScene extends Phaser.Scene {
    ...
    preload() {
        this.load.image('penguin1', 'assets/penguin1.png', { frameWidth: 355, frameHeight: 450 } as any);
        this.load.image('penguin2', 'assets/penguin2.png', { frameWidth: 355, frameHeight: 450 } as any);
        this.load.image('penguin3', 'assets/penguin3.png', { frameWidth: 355, frameHeight: 450 } as any);
    }
...
class Controller extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('fire', 'assets/fire.png', { frameWidth: 355, frameHeight: 450 } as any);
    }
